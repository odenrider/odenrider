...
| Metric | |
|:-------|:--|
| **10** | Patent applications filed (9 Soqucoin/PQCAT + Oracle ONCLAVE) |
...
- **PQCAT** — Post-Quantum Compliance Assessment Tool. 10 scanner modules, 11 compliance frameworks (CNSA 2.0, FedRAMP, FISMA, PCI, HIPAA). Dual-edition with air-gapped Enclave mode. Forecasted $5M–$35M ARR.
...
<sub>Soqucoin Labs Inc · New York, NY · [soqu.org](https://soqu.org) · [LinkedIn](https://linkedin.com/in/odenrider)</sub>
